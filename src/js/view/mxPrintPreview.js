...
function mxPrintPreview(
  ...
  this.pageFormat = mxRectangle.fromRectangle(
...
mxPrintPreview.prototype.open = function (
  ...
  try {
    ...
    if (this.printControls) {
      this.graph.cellRenderer.initControl = function (
        state,
        control,
        handleEvents,
        clickHandler
    ...
    var writePageSelector = mxUtils.bind(this, function () {
      if (this.pageSelector && (vpages > 1 || hpages > 1)) {
        ...
        if (
          ...
          var update = function () {
            table.style.top =
              (doc.body.scrollTop || doc.documentElement.scrollTop) + 10 + "px";
          };
    ...
    var addPage = mxUtils.bind(this, function (div, addBreak) {
      ...
      if (
        isNewWindow &&
        (mxClient.IS_IE || document.documentMode >= 11 || mxClient.IS_EDGE)
      ) {
 ...
 */
mxPrintPreview.prototype.renderPage = function (
  w,
  h,
  dx,
  dy,
 ...
 */
mxPrintPreview.prototype.addGraphFragment = function (
  dx,
  dy,
  scale,
  pageNumber,
