  ...
  function updateBackgroundImage() {
    if (newBackgroundImage == null) {
      ...
      changeImageLink.innerHTML =
        mxUtils.htmlEntities(mxResources.get("change")) + "...";
    } else {
...
(function () {
   ...
   */
  var mxGraphHandlerIsPropagateSelectionCell =
    ...
    if (immediate) {
      ...
      if (this.graph.isTableCell(cell) || this.graph.isTableRow(cell)) {
        ...
        result =
          ...
          (this.graph.isCellSelected(table) &&
  ...
  mxPopupMenuHandler.prototype.getCellForPopupEvent = function (me) {
    ...
    while (state != null && (model.isVertex(parent) || model.isEdge(parent))) {
      ...
      if (
        temp ||
        (!selected &&
          (this.graph.isTableCell(cell) || this.graph.isTableRow(cell)))
      ) {
        cell = parent;
      }
