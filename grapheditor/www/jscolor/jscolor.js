  ...
  color: function (target, prop) {
    ...
    function removePicker() {
      ...
      document
        ...
        .removeChild(mxJSColor.picker.boxB);
    }
    ...
    function drawPicker(x, y) {
      ...
      p.padM.style.backgroundImage =
        "url('" + mxJSColor.getDir() + "cross.gif')";
      p.padM.style.backgroundRepeat = "no-repeat";
      p.sldM.style.backgroundImage =
        "url('" + mxJSColor.getDir() + "arrow.gif')";
      p.sldM.style.backgroundRepeat = "no-repeat";
      p.pad.style.backgroundImage =
        "url('" + mxJSColor.getDir() + padImg + "')";
    ...
    function getPickerDims(o) {
      var dims = [
        2 * o.pickerInset +
          ...
          (o.slider
            ? 2 * o.pickerInset +
              2 * mxJSColor.images.arrow[0] +
              mxJSColor.images.sld[0]
            : 0),
        o.pickerClosable
          ? 4 * o.pickerInset +
            3 * o.pickerFace +
            mxJSColor.images.pad[1] +
    ...
    function redrawPad() {
      ...
      var y = Math.round(
        (1 - THIS.hsv[yComponent]) * (mxJSColor.images.pad[1] - 1)
      );
      mxJSColor.picker.padM.style.backgroundPosition =
        ...
        (THIS.pickerFace +
          THIS.pickerInset +
          y -
          Math.floor(mxJSColor.images.cross[1] / 2)) +
        "px";
    ...
    function redrawSld() {
      ...
      var y = Math.round(
        (1 - THIS.hsv[yComponent]) * (mxJSColor.images.sld[1] - 1)
      );
      mxJSColor.picker.sldM.style.backgroundPosition =
        ...
        (THIS.pickerFace +
          THIS.pickerInset +
          y -
          Math.floor(mxJSColor.images.arrow[1] / 2)) +
        "px";
    }
